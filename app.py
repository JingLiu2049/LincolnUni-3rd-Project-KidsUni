...
=======
        ...
        cur = getCursor()
        cur.execute("INSERT INTO admin(user_id, first_name, surname, phone_number, email) VALUES (%s,%s,%s,%s,%s);", (int(
            user_id), firstname, surname, phonenumber, email,))
        cur.execute(
...
=======
                filename = spreadsheet.gen_mem_temp(
                    schoolid, f'{request_file}')
>>>>>>> Stashed changes
